...
class MaterialColors {
  ...
  static const MaterialColor primarySwatch =
      MaterialColor(0xFF000C40, <int, Color>{
  ...
  final MaterialColor cetaceanBlue =
      const MaterialColor(0xFF000C40, <int, Color>{
        50: Color.fromRGBO(0, 12, 64, .1),
        100: Color.fromRGBO(0, 12, 64, .2),
        200: Color.fromRGBO(0, 12, 64, .3),
        300: Color.fromRGBO(0, 12, 64, .4),
  ...
  final MaterialColor antiFlashWhite =
      const MaterialColor(0xFFF0F2F0, <int, Color>{
        50: Color(0xFFF0F2F0),
  ...
  // Red color
  final MaterialColor redMaterialColor =
      const MaterialColor(0xFFFF0000, <int, Color>{
        50: Color(0xFFFFE6E6),
  ...
  // Blue-green color
  final MaterialColor blueGreenMaterialColor =
      const MaterialColor(0xFF00FFBF, <int, Color>{
        50: Color(0xFFE6FFF2),
  ...
  final MaterialColor yellowMaterialColor =
      const MaterialColor(0xFFFFEB3B, <int, Color>{
        50: Color(0xFFFFFDE7),
  ...
  final MaterialColor pinkMaterialColor =
      const MaterialColor(0xFFFF4081, <int, Color>{
        50: Color(0xFFFFF1F3),
  ...
  final MaterialColor cyanMaterialColor =
      const MaterialColor(0xFF00BCD4, <int, Color>{
        50: Color(0xFFE0F7FA),
  ...
  final MaterialColor purpleMaterialColor =
      const MaterialColor(0xFF6A1B9A, <int, Color>{
        50: Color(0xFFF3E5F5),
  ...
  final MaterialColor orangeMaterialColor =
      const MaterialColor(0xFFF57C00, <int, Color>{
        50: Color(0xFFFFF3E0),
  ...
  final MaterialColor greenMaterialColor =
      const MaterialColor(0xFF388E3C, <int, Color>{
        50: Color(0xFFE8F5E9),
  ...
  final MaterialColor grayMaterialColor =
      const MaterialColor(0xFF717171, <int, Color>{
        50: Color(0xFFFAFAFA),
